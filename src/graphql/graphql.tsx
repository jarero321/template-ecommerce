...
/** A shopping cart holds product variants and can be ordered. Each cart either beFloats to a registered customer or is an anonymous cart. */
export type Cart = ReferenceExpandable & Versioned & {
  ...
  totalLineItemQuantity?: Maybe<Scalars['Float']>;
  totalPrice: Money;
  version: Scalars['Float'];
};
...
export enum CartOrigin {
  ...
  Merchant = 'Merchant',
  /** The cart was created by our platform and beFloats to a Quote. BETA: This feature can be subject to change and should be used carefully in production. https://docs.commercetools.com/api/contract#public-beta */
  Quote = 'Quote'
}
...
export type DiscountCode = ReferenceExpandable & Versioned & {
  ...
  applicationCount: Scalars['Float'];
  applicationVersion?: Maybe<Scalars['Float']>;
  ...
  lastModifiedAt: Scalars['DateTime'];
  lastModifiedBy?: Maybe<Initiator>;
  maxApplications?: Maybe<Scalars['Float']>;
  maxApplicationsPerCustomer?: Maybe<Scalars['Float']>;
  name?: Maybe<Scalars['String']>;
  nameAllLocales?: Maybe<Array<LocalizedString>>;
  referenceRefs: Array<Reference>;
  validFrom?: Maybe<Scalars['DateTime']>;
...
export type DiscountCodeDraft = {
  ...
  isActive?: InputMaybe<Scalars['Boolean']>;
  maxApplications?: InputMaybe<Scalars['Float']>;
  maxApplicationsPerCustomer?: InputMaybe<Scalars['Float']>;
  name?: InputMaybe<Array<LocalizedStringItemInputType>>;
  validFrom?: InputMaybe<Scalars['DateTime']>;
  validUntil?: InputMaybe<Scalars['DateTime']>;
};
...
export type HighPrecisionMoney = BaseMoney & {
  ...
  currencyCode: Scalars['Currency'];
  fractionDigits: Scalars['Int'];
  preciseAmount: Scalars['Float'];
  type: Scalars['String'];
};

export type HighPrecisionMoneyInput = {
  centAmount?: InputMaybe<Scalars['Float']>;
  currencyCode: Scalars['Currency'];
  fractionDigits: Scalars['Int'];
  preciseAmount: Scalars['Float'];
};
...
export type InventoryEntryQuantitySet = MessagePayload & {
  ...
  newQuantityOnStock: Scalars['Float'];
  oldAvailableQuantity: Scalars['Float'];
  oldQuantityOnStock: Scalars['Float'];
  supplyChannel?: Maybe<Channel>;
  supplyChannelRef?: Maybe<Reference>;
  type: Scalars['String'];
};
...
export type MultiBuyCustomLineItemsTarget = CartDiscountTarget & {
  ...
  discountedQuantity: Scalars['Float'];
  maxOccurrence?: Maybe<Scalars['Int']>;
  predicate: Scalars['String'];
  selectionMode: SelectionMode;
  triggerQuantity: Scalars['Float'];
  type: Scalars['String'];
};
...
export type Mutation = {
   ...
   * Retrieves the authenticated customer (a customer that matches the given email/password pair).
   *
   * If used with an access token for Anonymous Sessions, all orders and carts beFloating to the `anonymousId` will be assigned to the newly created customer.
   *
  ...
  /** BETA: This feature can be subject to change and should be used carefully in production. https://docs.commercetools.com/api/contract#public-beta If used with an access token for Anonymous Sessions, all orders and carts beFloating to the anonymousId will be assigned to the newly created customer. */
...
export type Order = ReferenceExpandable & Versioned & {
  ...
  lastMessageSequenceNumber: Scalars['Float'];
  lastModifiedAt: Scalars['DateTime'];
  lastModifiedBy?: Maybe<Initiator>;
  lineItems: Array<LineItem>;
  locale?: Maybe<Scalars['Locale']>;
...
export type QuoteDraft = {
  ...
  stagedQuoteVersion?: InputMaybe<Scalars['Float']>;
  state?: InputMaybe<ReferenceInput>;
};
...
export type QuoteRequestDraft = {
  cart?: InputMaybe<ResourceIdentifierInput>;
  cartVersion?: InputMaybe<Scalars['Float']>;
  comment?: InputMaybe<Scalars['String']>;
  custom?: InputMaybe<CustomFieldsDraft>;
  key?: InputMaybe<Scalars['String']>;
  purchaseOrderNumber?: InputMaybe<Scalars['String']>;
...
export type RangeCountFloat = RangeCount & {
  __typename?: 'RangeCountFloat';
  count: Scalars['Int'];
  from: Scalars['Float'];
  fromStr: Scalars['String'];
  max: Scalars['Float'];
...
export type StagedQuoteDraft = {
  ...
  quoteRequestVersion?: InputMaybe<Scalars['Float']>;
  state?: InputMaybe<ReferenceInput>;
};
...
export type CreateCartMutation = { __typename?: 'Mutation', createMyCart?: { __typename: 'Cart', version: number, cartId: string } | null };
...
export type UpdateCartMutation = { __typename?: 'Mutation', updateMyCart?: { __typename: 'Cart', id: string, version: number, lineItems: Array<{ __typename: 'LineItem', quantity: number, lineId: string }> } | null };
...
export type GetCartQuery = { __typename?: 'Query', myCart: { __typename: 'Me', activeCart?: { __typename: 'Cart', version: number, cartId: string, lineItems: Array<{ __typename: 'LineItem', name?: string | null, productSlug?: string | null, quantity: number, lineId: string, price: { __typename: 'ProductPrice', value: { __typename: 'HighPrecisionMoney', centAmount: number, currencyCode: any, fractionDigits: number } | { __typename: 'Money', centAmount: number, currencyCode: any, fractionDigits: number }, discounted?: { __typename: 'DiscountedProductPriceValue', value: { __typename: 'HighPrecisionMoney', centAmount: number, currencyCode: any, fractionDigits: number } | { __typename: 'Money', centAmount: number, currencyCode: any, fractionDigits: number }, discount?: { __typename: 'ProductDiscount', name?: string | null } | null } | null }, totalPrice?: { __typename: 'Money', centAmount: number, currencyCode: any, fractionDigits: number } | null, variant?: { __typename: 'ProductVariant', sku?: string | null, images: Array<{ __typename: 'Image', url: string }>, attributesRaw: Array<{ __typename: 'RawProductAttribute', name: string, value: any, attributeDefinition?: { __typename: 'AttributeDefinition', name: string, label?: string | null, type: { __typename: 'BooleanAttributeDefinitionType', name: string } | { __typename: 'DateAttributeDefinitionType', name: string } | { __typename: 'DateTimeAttributeDefinitionType', name: string } | { __typename: 'EnumAttributeDefinitionType', name: string } | { __typename: 'LocalizableEnumAttributeDefinitionType', name: string } | { __typename: 'LocalizableTextAttributeDefinitionType', name: string } | { __typename: 'MoneyAttributeDefinitionType', name: string } | { __typename: 'NestedAttributeDefinitionType', name: string } | { __typename: 'NumberAttributeDefinitionType', name: string } | { __typename: 'ReferenceAttributeDefinitionType', name: string } | { __typename: 'SetAttributeDefinitionType', name: string } | { __typename: 'TextAttributeDefinitionType', name: string } | { __typename: 'TimeAttributeDefinitionType', name: string } } | null }> } | null }>, totalPrice: { __typename: 'Money', centAmount: number, currencyCode: any, fractionDigits: number }, shippingInfo?: { __typename: 'ShippingInfo', shippingMethod?: { __typename: 'ShippingMethod', name: string, localizedDescription?: string | null, methodId: string } | null, price: { __typename: 'Money', centAmount: number, currencyCode: any, fractionDigits: number } } | null, taxedPrice?: { __typename: 'TaxedPrice', totalGross: { __typename: 'Money', centAmount: number, currencyCode: any, fractionDigits: number }, totalNet: { __typename: 'Money', centAmount: number, currencyCode: any, fractionDigits: number } } | null, discountCodes: Array<{ __typename: 'DiscountCodeInfo', discountCode?: { __typename: 'DiscountCode', code: string, name?: string | null, codeId: string } | null }>, shippingAddress?: { __typename: 'Address', firstName?: string | null, lastName?: string | null, streetName?: string | null, additionalStreetInfo?: string | null, postalCode?: string | null, city?: string | null, country: any, phone?: string | null, email?: string | null } | null, billingAddress?: { __typename: 'Address', firstName?: string | null, lastName?: string | null, streetName?: string | null, additionalStreetInfo?: string | null, postalCode?: string | null, city?: string | null, country: any, phone?: string | null, email?: string | null } | null } | null } };
...
export type GetCategoriesQuery = { __typename?: 'Query', categories: { __typename?: 'CategoryQueryResult', results: Array<{ __typename?: 'Category', stagedProductCount: number, name?: string | null, id: string, children?: Array<{ __typename?: 'Category', name?: string | null }> | null }> } };

export type GetProductProjectionQueryVariables = Exact<{
  locale: Scalars['Locale'];
  id: Scalars['String'];
}>;


export type GetProductProjectionQuery = { __typename?: 'Query', productProjectionSearch: { __typename?: 'ProductProjectionSearchResult', results: Array<{ __typename?: 'ProductProjection', slug?: string | null, name?: string | null, description?: string | null, categories: Array<{ __typename?: 'Category', name?: string | null }>, variants: Array<{ __typename?: 'ProductSearchVariant', id: number }>, reviewRatingStatistics?: { __typename?: 'ReviewRatingStatistics', averageRating: number } | null, masterVariant: { __typename?: 'ProductSearchVariant', sku?: string | null, prices?: Array<{ __typename?: 'ProductPriceSearch', value: { __typename?: 'HighPrecisionMoney', type: string, currencyCode: any, centAmount: number, fractionDigits: number } | { __typename?: 'Money', type: string, currencyCode: any, centAmount: number, fractionDigits: number } }> | null, attributesRaw: Array<{ __typename?: 'RawProductSearchAttribute', name: string, value: any }>, images: Array<{ __typename?: 'ImageProductSearch', url: string }> } }> } };
...
export type GetProductSearhQuery = { __typename?: 'Query', productProjectionSearch: { __typename?: 'ProductProjectionSearchResult', results: Array<{ __typename?: 'ProductProjection', slug?: string | null, name?: string | null, description?: string | null, categories: Array<{ __typename?: 'Category', name?: string | null }>, variants: Array<{ __typename?: 'ProductSearchVariant', id: number }>, reviewRatingStatistics?: { __typename?: 'ReviewRatingStatistics', averageRating: number } | null, masterVariant: { __typename?: 'ProductSearchVariant', sku?: string | null, prices?: Array<{ __typename?: 'ProductPriceSearch', value: { __typename?: 'HighPrecisionMoney', type: string, currencyCode: any, centAmount: number, fractionDigits: number } | { __typename?: 'Money', type: string, currencyCode: any, centAmount: number, fractionDigits: number } }> | null, attributesRaw: Array<{ __typename?: 'RawProductSearchAttribute', name: string, value: any }>, images: Array<{ __typename?: 'ImageProductSearch', url: string }> } }> } };
...
export type GetProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductQueryResult', results: Array<{ __typename?: 'Product', masterData: { __typename?: 'ProductCatalogData', current?: { __typename?: 'ProductData', name?: string | null, description?: string | null, masterVariant: { __typename?: 'ProductVariant', sku?: string | null, images: Array<{ __typename?: 'Image', url: string, label?: string | null }>, price?: { __typename?: 'ProductPrice', value: { __typename?: 'HighPrecisionMoney', type: string, currencyCode: any, centAmount: number, fractionDigits: number } | { __typename?: 'Money', type: string, currencyCode: any, centAmount: number, fractionDigits: number } } | null } } | null } }> } };
...
export type CustomerCreateMutation = { __typename?: 'Mutation', customerSignMeUp: { __typename?: 'CustomerSignInResult', customer: { __typename?: 'Customer', id: string, isEmailVerified: boolean, firstName?: string | null, lastName?: string | null } } };
...
export type CustomerLoginMutation = { __typename?: 'Mutation', customerSignMeIn: { __typename?: 'CustomerSignInResult', customer: { __typename?: 'Customer', id: string, isEmailVerified: boolean, firstName?: string | null, lastName?: string | null } } };
...
export const UpdateCartDocument = gql`
    mutation updateCart($actions: [MyCartUpdateAction!]!, $version: Float!, $id: String!) {
...
export const GetProductProjectionDocument = gql`
    query getProductProjection($locale: Locale!, $id: String!) {
  productProjectionSearch(
    locale: $locale
    text: ""
    sorts: ["price"]
    queryFilters: {model: {tree: {path: "categories.id", rootValues: [], subTreeValues: [$id]}}}
  ) {
    results {
      slug(locale: $locale)
      categories {
...
/**
 * __useGetProductProjectionQuery__
 *
 * To run a query within a React component, call `useGetProductProjectionQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductProjectionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductProjectionQuery({
 *   variables: {
 *      locale: // value for 'locale'
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetProductProjectionQuery(baseOptions: Apollo.QueryHookOptions<GetProductProjectionQuery, GetProductProjectionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductProjectionQuery, GetProductProjectionQueryVariables>(GetProductProjectionDocument, options);
      }
export function useGetProductProjectionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductProjectionQuery, GetProductProjectionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductProjectionQuery, GetProductProjectionQueryVariables>(GetProductProjectionDocument, options);
        }
export type GetProductProjectionQueryHookResult = ReturnType<typeof useGetProductProjectionQuery>;
export type GetProductProjectionLazyQueryHookResult = ReturnType<typeof useGetProductProjectionLazyQuery>;
export type GetProductProjectionQueryResult = Apollo.QueryResult<GetProductProjectionQuery, GetProductProjectionQueryVariables>;
export const GetProductSearhDocument = gql`
...
/**
 * __useGetProductSearhQuery__
 *
 * To run a query within a React component, call `useGetProductSearhQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductSearhQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductSearhQuery({
 *   variables: {
 *      locale: // value for 'locale'
 *      text: // value for 'text'
 *   },
 * });
 */
export function useGetProductSearhQuery(baseOptions: Apollo.QueryHookOptions<GetProductSearhQuery, GetProductSearhQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductSearhQuery, GetProductSearhQueryVariables>(GetProductSearhDocument, options);
      }
export function useGetProductSearhLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductSearhQuery, GetProductSearhQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductSearhQuery, GetProductSearhQueryVariables>(GetProductSearhDocument, options);
        }
export type GetProductSearhQueryHookResult = ReturnType<typeof useGetProductSearhQuery>;
export type GetProductSearhLazyQueryHookResult = ReturnType<typeof useGetProductSearhLazyQuery>;
export type GetProductSearhQueryResult = Apollo.QueryResult<GetProductSearhQuery, GetProductSearhQueryVariables>;
